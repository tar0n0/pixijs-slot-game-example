...
const _ViewportQuad = class extends Quad {
  update(viewport) {
    ...
    if (b[0] !== x1 || b[1] !== y1 || b[4] !== x2 || b[5] !== y2) {
      b[0] = b[6] = x1;
      b[1] = b[3] = y1;
      b[2] = b[4] = x2;
      b[5] = b[7] = y2;
...
let ViewportQuad = _ViewportQuad;
ViewportQuad._instance = new _ViewportQuad();

export { ViewportQuad };
//# sourceMappingURL=ViewportQuad.mjs.map
